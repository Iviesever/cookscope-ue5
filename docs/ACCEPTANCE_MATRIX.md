...
| PACT-70-02 | Complete core and UE Automation suites | Fresh logs bound to source SHA | NOT RUN: second-audit fix source replay pending |
| PACT-70-03 | BuildPlugin and local package | Paths, sizes, SHA-256, source SHA | NOT RUN: second-audit fix package pending |
| PACT-70-04 | Fresh extraction and clean-source smoke | Commands, logs, checksums | NOT RUN: second-audit fix extraction replay pending |
| DOC-01 | Portfolio/interview/release documentation matches facts | Link and claim audit | NOT RUN: final post-fix document check pending |
