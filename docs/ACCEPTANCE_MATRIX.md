...
|---|---|---|---|
| PACT-00-01 | Public repository, local baseline, feature branch, Draft PR | GitHub URLs and SHAs | PASS: public `Iviesever/cookscope-ue5`; baseline `2bede4a`; PR #1 merged as `2c3ae0a` |
